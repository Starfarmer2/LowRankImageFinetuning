...
correct_text_inputs = tokenizer(["Five cars red hospital ten yuan six cards Ben"], padding=True, return_tensors="pt")
...
def fgsm_attack(original_token_vectors, original_position_vectors, correct_text_embeds, incorrect_text_embeds, encoder_layer, final_norm_layer, text_projection_layer, lr, L=50):
...
if __name__ == '__main__':
    fgsm_attack(correct_token_vectors, correct_position_vectors, correct_text_embeds, image_embeds, encoder_layer=encoder_layer, final_norm_layer=final_norm_layer, text_projection_layer=text_projection_layer, lr=20)
    None
